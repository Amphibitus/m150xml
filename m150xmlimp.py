...
def float_de(value: Union[str, float], default: float = 0.0):
...
# funktioniert noch nicht  
    ...
    for gp in gpa :
        ...
        if pkt==1: #attribut in ['DMP','SMP','SBD','HP','GOK']:
            Liste.update(X1=x)
            Liste.update(Y1=y)
            Liste.update(Z1=z)
        else:
...
#https://docs.python.org/2/library/xml.etree.elementtree.html
    ...
    def _readSchaechteISYBAU(self):
        ...
        schaechte = self._data.findall("d:Datenkollektive/d:Stammdatenkollektiv/d:AbwassertechnischeAnlage/[d:Objektart='2']",self._NS)
    ...
    def _readHaltungenISYBAU(self):
        ...
        haltungen =  self._data.findall("d:Datenkollektive/d:Stammdatenkollektiv/d:AbwassertechnischeAnlage/[d:Objektart='1']",self._NS)
        for p in haltungen:
        ...
        for p in haltungen:
            ...
            for ins in inspektionen:
                ...
                for stat in stationen:
                    ...
                    # Guard: fehlende Koordinaten -> Station nicht berechenbar
                    if x1 is None or y1 is None or x2 is None or y2 is None:
                        QgsMessageLog.logMessage("Coordinates were not determined:"+str(insnr), 'M150xml', Qgis.Info)
                        continue
        ...
        for p in schaechte:
            ...
            for ins in inspektionenSchacht:
                ...
                for stat in stationenSchacht:
                    ...
                    tiefe_roh = stationSchacht.get('Tiefe')
                    staa = float(tiefe_roh) if tiefe_roh is not None else 0.0
